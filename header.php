...
<head>
	...
	<link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Kufam:wght@600&family=Open+Sans:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=Roboto+Mono&display=swap" />
	<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Kufam:wght@600&family=Open+Sans:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=Roboto+Mono&display=swap" media="print" onload="this.media='all'" />
	<noscript>
		<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Kufam:wght@600&family=Open+Sans:ital,wght@0,400;0,600;0,700;1,400;1,600;1,700&family=Roboto+Mono&display=swap" />
	</noscript>
