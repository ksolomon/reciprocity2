...
add_option('sfsm_items_per_page', 50);
...
function sfsm_add_option_pages() {
	if (function_exists('add_options_page')) {
		add_options_page('Sitemap Generator', 'Sitemap Gen', 8, __FILE__, 'sfsm_options_page');
	}
}
...
function sfsm_options_page() {
	...
	if (isset($_POST['set_defaults'])) {
		...
		update_option('sfsm_language', (string) $_POST["sfsm_language"]);
	...
	<?php echo SFSM_ITEMS_PER_PAGE_INFO; ?>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_SITEMAP_SLUG; ?></th><td valign="top">
	<input name="sfsm_sm_name" type="text" size="25" value="<?php echo get_option('sfsm_sm_name') ?>"/><br />
	<?php echo SFSM_SITEMAP_SLUG_INFO; ?>
	</td></tr>
	...
	<input name="sfsm_what_to_show" type="radio" value="both" <?php if (get_option('sfsm_what_to_show') == "both") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_SHOW_BOTH; ?><br />
	<input name="sfsm_what_to_show" type="radio" value="posts" <?php if (get_option('sfsm_what_to_show') == "posts") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_SHOW_POSTS; ?><br />
	<input name="sfsm_what_to_show" type="radio" value="pages" <?php if (get_option('sfsm_what_to_show') == "pages") echo "checked='checked'"; ?>/>&nbsp;&nbsp;	<?php echo SFSM_SHOW_PAGES; ?>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_WHICH_FIRST; ?></th><td valign="top">
	<input name="sfsm_which_first" type="radio" value="posts" <?php if (get_option('sfsm_which_first') == "posts") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_WHICH_FIRST_POSTS; ?><br />
	<input name="sfsm_which_first" type="radio" value="pages" <?php if (get_option('sfsm_which_first') == "pages") echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo SFSM_WHICH_FIRST_PAGES; ?>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_POST_SORT; ?></th><td valign="top">
	<label><input name="sfsm_post_sort_order" type="radio" value="title" <?php if (get_option('sfsm_post_sort_order') == "title") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_POST_SORT_T; ?><br /></label>
	<label><input name="sfsm_post_sort_order" type="radio" value="datea" <?php if (get_option('sfsm_post_sort_order') == "datea") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_POST_SORT_DA; ?><br /></label>
	<label><input name="sfsm_post_sort_order" type="radio" value="dated" <?php if (get_option('sfsm_post_sort_order') == "dated") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_POST_SORT_DD; ?><br /></label>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_PAGE_SORT; ?></th><td valign="top">
	<label><input name="sfsm_page_sort_order" type="radio" value="title" <?php if (get_option('sfsm_page_sort_order') == "title") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_PAGE_SORT_T; ?><br /></label>
	<label><input name="sfsm_page_sort_order" type="radio" value="datea" <?php if (get_option('sfsm_page_sort_order') == "datea") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_PAGE_SORT_DA; ?><br /></label>
	<label><input name="sfsm_page_sort_order" type="radio" value="dated" <?php if (get_option('sfsm_page_sort_order') == "dated") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_PAGE_SORT_DD; ?><br /></label>
	<label><input name="sfsm_page_sort_order" type="radio" value="menua" <?php if (get_option('sfsm_page_sort_order') == "menua") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_PAGE_SORT_MA; ?><br /></label>
	<label><input name="sfsm_page_sort_order" type="radio" value="menud" <?php if (get_option('sfsm_page_sort_order') == "menud") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_PAGE_SORT_MD; ?><br /></label>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_POST_COMMENTS; ?></th><td valign="top">
	<input type="checkbox" name="sfsm_comments_on_posts" value="checkbox" <?php if (get_option('sfsm_comments_on_posts')) echo "checked='checked'"; ?>/>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_PAGE_COMMENTS; ?></th><td valign="top">
	<input type="checkbox" name="sfsm_comments_on_pages" value="checkbox" <?php if (get_option('sfsm_comments_on_pages')) echo "checked='checked'"; ?>/>
	</td></tr>
	...
	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_PAGE_DATES; ?></th><td valign="top">
	<input type="checkbox" name="sfsm_show_page_date" value="checkbox" <?php if (get_option('sfsm_show_page_date')) echo "checked='checked'"; ?>/>
	</td></tr>
	...
	<input name="sfsm_excluded_cats" type="text" size="55" value="<?php echo get_option('sfsm_excluded_cats') ?>"/><br />
	<?php echo SFSM_EXCLUDED_CATS_DESC; ?>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_EXCLUDED_PAGES; ?></th><td valign="top">
	<input name="sfsm_excluded_pages" type="text" size="55" value="<?php echo get_option('sfsm_excluded_pages') ?>"/><br />
	<?php echo SFSM_EXCLUDED_PAGES_DESC; ?>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_HIDE_FUTURE; ?></th><td valign="top">
	<input type="checkbox" name="sfsm_hide_future" value="checkbox" <?php if (get_option('sfsm_hide_future')) echo "checked='checked'"; ?>/>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_HIDE_PASS; ?></th><td valign="top">
	<input type="checkbox" name="sfsm_hide_protected" value="checkbox" <?php if (get_option('sfsm_hide_protected')) echo "checked='checked'"; ?>/>
	</td></tr>
	...
	<label><input name="sfsm_page_nav_where" type="radio" value="top" <?php if (get_option('sfsm_page_nav_where') == "top") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_NAV_WHERE_TOP; ?><br /></label>
	<label><input name="sfsm_page_nav_where" type="radio" value="bottom" <?php if (get_option('sfsm_page_nav_where') == "bottom") echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_NAV_WHERE_BOT; ?><br /></label>
    <label><input name="sfsm_page_nav_where" type="radio" value="both" <?php if (get_option('sfsm_page_nav_where') == "both") echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo SFSM_NAV_WHERE_BOTH; ?></label>
	</td></tr>
	...
	<br /><?php echo SFSM_XML_PATH_DESC; ?>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_XML_WHERE; ?></th><td valign="top">
	<label><input name="sfsm_xml_where" type="radio" value="last" <?php if (get_option('sfsm_xml_where') == 'last') echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo SFSM_XML_WHERE_LAST; ?><br /></label>
	<label><input name="sfsm_xml_where" type="radio" value="every" <?php if (get_option('sfsm_xml_where') == 'every') echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo SFSM_XML_WHERE_EVERY; ?></label>
	</td></tr>

	<tr><th width="45%" valign="top" align="right" scope="row"><?php echo SFSM_NEW_WINDOW; ?></th><td valign="top">
	<input type="checkbox" name="sfsm_new_window" value="checkbox" <?php if (get_option('sfsm_new_window')) echo "checked='checked'"; ?>/>
	</td></tr>
	...
	<div class="submit">
		...
		<input type="submit" name="info_update" value="<?php echo SFSM_UPDATE_BUTTON; ?> &raquo;" />
	</div>
	...
	while (isset($cats[$k]) && ($cats[$k]->category_parent == $parent) && ($k < $num_cats)) {
		...
		if (count($cats_with_children) > 0) {
			if (in_array($cats[$k]->category_ID, $cats_with_children, FALSE)) {
				if (in_array($cats[$k]->category_ID, $excluded_cats, FALSE) === FALSE) {
					$cat_data = sfsm_get_cats($cat_data, $cats, $num_cats, $cats_with_children, $excluded_cats, $cats[$k]->category_ID, $level + 1);
				}
			}
		}
...
function sfsm_display_pages($page_data, $num_pages, $page_start, $page_end, $comments_on_pages, $new_window, $show_page_date, $date_format) {
	...
	$show_zero_comments = get_option('sfsm_show_zero_comments');
...
function sfsm_find_parent_post($post_data, $p, $k) {
	...
	return SFSM_CAT_HEADER . ' <a href="' . get_category_link($post_data[$p]['id']) . '" title="' . strip_tags($post_data[$p]['title']) . '">' . $post_data[$p]['title'] . '</a>';
 ...
 */
function sfsm_remove_empty_cats($post_data) {
 ...
 */
function sfsm_generate_nav($total_pages, $current_page, $page_nav, $sm_name) {
	...
	if (strlen($sm_name) > 0) { // permalinks enabled
		...
		if ($total_pages > 1) {
			...
			if ($page_nav == 1) {
				...
				$output1 .= '<div class="sfsm-pagenav"><p>Pages: ';
...
function sfsm_create_sitemap() {
	...
	$items_per_page = (int)get_option('sfsm_items_per_page');
	$sm_name = (string)get_option('sfsm_sm_name');
	$what_to_show = trim(get_option('sfsm_what_to_show'));
	$which_first = trim(get_option('sfsm_which_first'));
	$post_sort_order = trim(get_option('sfsm_post_sort_order'));
	$page_sort_order = trim(get_option('sfsm_page_sort_order'));
	$comments_on_posts = get_option('sfsm_comments_on_posts');
	$comments_on_pages = get_option('sfsm_comments_on_pages');
	$hide_future = get_option('sfsm_hide_future');
	$new_window = get_option('sfsm_new_window');
	$show_post_date = get_option('sfsm_show_post_date');
	$show_page_date = get_option('sfsm_show_page_date');
	$date_format = get_option('sfsm_date_format');
	$hide_protected = get_option('sfsm_hide_protected');
	$excluded_cats = trim(get_option('sfsm_excluded_cats'));
	$excluded_pages = trim(get_option('sfsm_excluded_pages'));
	$page_nav = trim(get_option('sfsm_page_nav'));
	$page_nav_where = trim(get_option('sfsm_page_nav_where'));
	$xml_path = trim(get_option('sfsm_xml_path'));
	$xml_where = get_option('sfsm_xml_where');
	...
	if ($what_to_show != 'pages') {
		...
		$post_data = sfsm_merge_cats_posts($post_data, $posts, $cat_data, $num_posts, $num_cats, $comments_on_posts, $show_post_date);

		$post_data = sfsm_remove_empty_cats($post_data);
	...
	if ($what_to_show != 'posts') {
		...
		$page_data = sfsm_get_pages($page_data, $pages, $num_pages, $pages_with_children, $excluded_pages, $comments_on_pages, $show_page_date);
	...
	$t_out .= "\n\n<!-- START of Sitemap Generator output -->\n\n";

	$t_out .= '<div class="sfsm-wrapper">';


	if ($page_nav_where != 'bottom') {
		$t_out .= sfsm_generate_nav($total_pages, $current_page, $page_nav, $sm_name);
	}
	...
	if ($what_to_show == 'posts') { // show just posts
		...
		$t_out .= sfsm_display_posts($post_data, $num_posts, $post_start, $post_end, $comments_on_posts, $new_window, $show_post_date, $date_format);
		...
		$t_out .= sfsm_display_pages($page_data, $num_pages, $page_start, $page_end, $comments_on_pages, $new_window, $show_page_date, $date_format);
		...
		if ($which_first == 'pages') {
			$t_out .= sfsm_display_pages($page_data, $num1, $start1, $end1, $comments_on_pages, $new_window, $show_page_date, $date_format);
			$t_out .= sfsm_display_posts($post_data, $num2, $start2, $end2, $comments_on_posts, $new_window, $show_post_date, $date_format);
		} else {
			$t_out .= sfsm_display_posts($post_data, $num1, $start1, $end1, $comments_on_posts, $new_window, $show_post_date, $date_format);
			$t_out .= sfsm_display_pages($page_data, $num2, $start2, $end2, $comments_on_pages, $new_window, $show_page_date, $date_format);
		}
	...
	if ($xml_path != '') {
		if (($xml_where == 'every') OR ($current_page == $total_pages)) {
			$t_out .= '<div class="sfsm-xml-link"><p><a href="' . $xml_path . '">' . SFSM_VIEW_XML . '</a></p></div>';
		}
	}
	...
	$t_out .= "\n\n<!-- END of Sitemap Generator output -->\n\n";
...
function sfsm_generate_sitemap($content) {
	if (strpos($content, "[sitemap]") !== FALSE) {
		...
		$content = str_replace('[sitemap]', sfsm_create_sitemap(), $content);
	}
	return $content;
}
